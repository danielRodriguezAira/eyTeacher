...
@Mapper(componentModel = "spring", uses = {UserResponseMapper.class, TopicResponseMapper.class, ValueObjectMapper.class})
public interface CategoryResponseMapper {
    ...
    @Mapping(target = "name", source = "category.name", qualifiedByName = "fromName")
